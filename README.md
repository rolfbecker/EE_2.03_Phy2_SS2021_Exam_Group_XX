...
1. Create **your own HSRW gitlab repository** from the downloaded and renamed directory tree, i.e. create a HSRW gitlab repository named `EE_2.03_Phy2_SS2021_Exam_Group_Z` from your local folder if your Moodle group is `Z`.
